  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: Colors.white, boxShadow: [BoxShadow(blurRadius: 7, offset: const Offset(0, 7), color: Colors.grey[300]!)]),
        child: Column(
          ...
          children: [
            StepProgressIndicator(
              ...
              unselectedGradientColor: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [Colors.white, Colors.white]),
            ),
            Padding(
