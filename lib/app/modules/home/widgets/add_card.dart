...
import 'package:getx_todo_list/app/widgets/icon.dart';
    ...
    return Container(
      ...
      child: InkWell(
                    ...
                    ElevatedButton(
                      onPressed: (){
                        if(homeCtrl.formKey.currentState!.validate()){
                          ...
                          Get.back();
                          homeCtrl.addTask(task) ? EasyLoading.showSuccess('Create susscess'): EasyLoading.showError('status');
                        }
                      },
        ...
        child: DottedBorder(
          ...
          child: Center(
            child: Icon(Icons.add, size: 10.0.wp,
              color: Colors.grey,
            ),
